...
├── .agents/
│   └── rules/
│       └── project_context_priority.md # Priority Rule: Read AI_PROJECT_CONTEXT.md first
├── .github/
│   └── workflows/
│       └── ci.yml                     # GitHub Actions CI/CD pipeline (main & master)
├── docs/                              # Central project documentation directory
│   ├── AI_PROJECT_CONTEXT.md          # Primary technical context source-of-truth
│   ├── PERFORMANCE_OPTIMIZATION_REPORT.md # 15-Point Senior Performance Engineering Report
│   ├── README.md                      # Documentation hub index
│   └── walkthrough.md                 # CA Practice Dashboard KPI walkthrough
├── apps/
...
│   │   │   ├── middleware/            # Auth guard, error handling, rate limiting, logging, profiler
...
├── AI_PROJECT_CONTEXT.md              # Primary technical context & architecture source of truth
├── GEMINI.md                          # Mandatory priority instructions for AI agents
├── README.md                          # Monorepo overview and developer setup guide
